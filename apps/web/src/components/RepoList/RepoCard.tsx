import type { Repository } from '@ohnicerepo/shared';
...
export function RepoCard({ repo, index }: RepoCardProps) {
  return (
    <div className="repo-card" style={{ animationDelay: `${index * 0.05}s` }}>
      ...
      <div className="repo-meta">
        ...
        <span className="repo-date">Created {formatDate(repo.createdAt)}</span>
      </div>
    </div>
  );
}
