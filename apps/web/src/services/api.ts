import type { ApiResponse, ClientCacheEntry, FilterParams, RateLimit } from '@ohnicerepo/shared';
import { CLIENT_CACHE_TTL } from '../constants/cache';
import { generateClientCacheKey } from '../utils/cache';

// API base URL - static constant
const API_BASE_URL = 'https://ohnice-repo-api.bhnmzm.workers.dev';
...
export async function fetchRepositories(
  ...
  // Construct the full API URL using static constant
  const apiUrl = `${API_BASE_URL}/api/repos?${queryParams.toString()}`;
